...
$taskName = "AD-user-generate-table-report-recently-created"
$taskGetAdUsersGuid = ""
...
$dataSourceName = "AD-user-generate-table-report-recently-created"
...
try {
    ...
    if([string]::IsNullOrEmpty($response.dataSourceGUID)) {
        ...
        $body = @{
            name = "$dataSourceName";
            type = "3";
            model = @(@{key = "CanonicalName"; type = 0}, @{key = "Department"; type = 0}, @{key = "Displayname"; type = 0}, @{key = "Enabled"; type = 0}, @{key = "SamAccountName"; type = 0}, @{key = "Title"; type = 0}, @{key = "UserPrincipalName"; type = 0}, @{key = "whenCreated"; type = 0});
...
$formName = "AD - Report - Accounts created during the last 30 days"
$formGuid = ""
...
try
{
        ...
        [
  {
    ...
    "body": "The following report will show local AD accounts that have been created during the last 30 days. Please wait while the data is loading...",
...
$delegatedFormName = "AD - Report - Accounts created during the last 30 days"
$delegatedFormGuid = ""
...
$taskActionName = "AD-export-report-accounts-recently-created"
$taskActionGuid = ""
